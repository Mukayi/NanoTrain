"""Shakespeare character dataset loader compatible with nanoGPT artifacts."""
...
class ShakespeareCharDataset:
    """Reads nanoGPT-style train.bin/val.bin files and returns random batches."""
    ...
    def _validate_files(self) -> None:
        ...
        if missing:
            raise FileNotFoundError(
                ...
                "Run nanoGPT/data/shakespeare_char/prepare.py first."
            )
